...
function item(overrides: Partial<SnapshotItem> = {}): SnapshotItem {
  ...
  return {
    ...
    primary_category: overrides.primary_category ?? "equity",
    secondary_category: overrides.secondary_category ?? "equity.large_cap",
    tertiary_categories: overrides.tertiary_categories ?? [],
    regions: overrides.regions ?? ["US_CA"],
    trend_score: 45,
    rs_score: 72,
    early_reversal: 112,
